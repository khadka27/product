            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="extra_badge_1">
                        Extra Badge 1 <span className="text-red-500">*</span>
                      </Label>
                      <div className="text-xs text-gray-500 mb-2">
                        Upload additional badge or icon
                      </div>
                      <Input
                        id="extra_badge_1"
                        type="file"
                        name="extra_badge_1"
                        accept="image/*"
                        onChange={(e) => handleFileChange(e, "extra_badge_1")}
                        className="cursor-pointer"
                        required
                      />
                      {extraBadge1Preview && (
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="extra_badge_2">
                        Extra Badge 2 <span className="text-red-500">*</span>
                      </Label>
                      <div className="text-xs text-gray-500 mb-2">
                        Upload additional badge or icon
                      </div>
                      <Input
                        ...
                        name="extra_badge_2"
                        accept="image/*"
                        onChange={(e) => handleFileChange(e, "extra_badge_2")}
                        className="cursor-pointer"
                        required
                      />
                      {extraBadge2Preview && (
                ...
                <TabsContent value="content" className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="rename_reason">
                      Why Rename? <span className="text-red-500">*</span>
                    </Label>
                    <Textarea
                      id="rename_reason"
                      name="rename_reason"
                      value={formData.rename_reason}
                      placeholder="After extensive market research and customer feedback..."
                      onChange={handleChange}
                      className="min-h-[100px]"
                      required
                    />
                    <p className="text-xs text-gray-500">
                      Explain why the product is being renamed. This will be
                ...
                <TabsContent value="settings" className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="release_date" className="text-sm">
                          Release Date
                        </Label>
                        <Input
                          id="release_date"
