...
//     if (activePoints < 4) {
//       // Find the first empty slot and focus it
//       const emptyIndex = formData.description_points.findIndex(
//         (p) => p.trim() === ""
//       );
//       if (emptyIndex >= 0) {
//         // The element will be focused after render
//         setTimeout(() => {
//           const element = document.getElementById(`bullet-point-${emptyIndex}`);
//           if (element) {
//             element.focus();
//           }
//         }, 0);
...
//       // Reorganize to move empty slots to the end
//       const nonEmptyPoints = newPoints.filter((p) => p.trim() !== "");
//       const emptyCount = 4 - nonEmptyPoints.length;
//       const reorganizedPoints = [
//         ...nonEmptyPoints,
//         ...Array(emptyCount).fill(""),
//       ];

//       return { ...prev, description_points: reorganizedPoints };
//     });
...
//       (p) => p.trim() !== ""
//     );
//     nonEmptyPoints.forEach((point, index) => {
//       data.append(`description_point_${index + 1}`, point);
//     });
...
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                     <div className="space-y-2">
//                       <Label htmlFor="old_name">Product 1 Name (From)</Label>
//                       <Input
//                         id="old_name"
//                         type="text"
//                         name="old_name"
...
//                     </div>
//                     <div className="space-y-2">
//                       <Label htmlFor="new_name">Product 2 Name (To)</Label>
//                       <Input
//                         id="new_name"
//                         type="text"
//                         name="new_name"
...
//                       <Label htmlFor="bullet_points">Bullet Points (2-4)</Label>
//                       {activePoints < 4 && (
//                         <Button
//                           type="button"
//                           variant="outline"
